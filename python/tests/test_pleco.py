...
class TestCardLine:
    def test_formats_all_fields(self):
        word = {
            ...
            "german": "Test",
            "example_zh": "这是测试",
            "example_de": "Das ist ein Test",
        }
        assert _card_line(word) == "测试\tcè shì\tTest | 这是测试 Das ist ein Test"
    ...
    def test_falls_back_to_english_when_no_german(self):
        ...
        assert _card_line(word) == "测试\tcè shì\ttest"
    ...
    def test_example_zh_without_example_de(self):
        ...
        assert _card_line(word) == "好\thǎo\tgut | 你好"

    def test_no_example_fields(self):
        word = {"chinese": "好", "pinyin": "hǎo", "german": "gut", "example_zh": "", "example_de": ""}
        assert _card_line(word) == "好\thǎo\tgut"
...
class TestGeneratePlecoFile:
    def test_creates_file_with_header(self, tmp_path):
        episode = {"episode": 265, "title": "#265[中级]: Test Topic", "words": [], "idioms": []}
    ...
    def test_strips_episode_prefix_from_title(self, tmp_path):
        episode = {"episode": 1, "title": "#1[中级]: My Topic", "words": [], "idioms": []}
    ...
    def test_writes_word_cards(self, tmp_path):
        episode = {
            "episode": 1,
            "title": "Test",
            "words": [{"chinese": "你好", "pinyin": "nǐ hǎo", "german": "Hallo", "example_zh": "", "example_de": ""}],
            "idioms": [],
        }
        out = tmp_path / "1_pleco.txt"
        generate_pleco_file(episode, out)
    ...
    def test_words_and_idioms_combined(self, tmp_path):
        episode = {
            "episode": 1,
            "title": "Test",
            "words": [{"chinese": "测试", "pinyin": "cè shì", "german": "Test", "example_zh": "", "example_de": ""}],
            "idioms": [{"chinese": "无懈可击", "pinyin": "wú xiè kě jī", "german": "einwandfrei", "example_zh": "", "example_de": ""}],
        }
        out = tmp_path / "1_pleco.txt"
        generate_pleco_file(episode, out)
        content = out.read_text(encoding="utf-8")
    ...
    def test_creates_parent_directory(self, tmp_path):
        episode = {"episode": 1, "title": "Test", "words": [], "idioms": []}
